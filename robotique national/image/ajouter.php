...
if(isset($_POST['submit'])){
  ...
  $nomPhoto1=$_FILES['img']['name'];
    $file_tmp_name=$_FILES['img']['tmp_name'];
    move_uploaded_file($file_tmp_name,"./$nomPhoto1");
    $id=$_POST['id'];
    $nom=$_POST['nom'];
    $type=$_POST['type'];
    // $genre=$_POST['genre'];
    ...
    $récompense=$_POST['récompense'];
    
    // $img=$_FILES['img']['name'];
    // $file_tmp_name=$_FILES['img']['tmp_name'];
    // move_uploaded_file($file_tmp_name,"./images/$img");

    $query =" insert into test  (id, nom, type, date,lieu,université,récompense,img) values('$id', '$nom', '$type','$date','$lieu','$université','$récompense','$nomPhoto1' )";
      ...
      <div class="container-fluid">
        ...
        <div class="row">
          ...
          <section class="col-lg-7 connectedSortable">
            ...
            <div class="card direct-chat direct-chat-primary">
              ...
              <div class="card-footer">
                ...
                <div >
                    <label >type </label>
                      ...
                      <option value="Intelegence Artificiel">Intelegence Artificiel</option>
                      </select>
                    </label>
              ...
              <div>
                ...
                <div>
                   ...
                   <input type="text" name="récompense"     />
                </div>
                <div>
                <label > image</label>
                ...
                <!-- date,lieu,université,récompense -->
                <!-- <a href="afficher.php">
                      <button name="submit" type="submit" class="btn btn-primary">Ajouter </button>
                  </a> -->
                  <a href="afficher.php">
                <button  href="afficher.php" name="submit" type="submit" class="btn btn-primary"    >ajouter </button>
            ...
            <!--/.direct-chat -->
            <h3>        Supprimer  des evenements</h3>
              <div class="card-footer">
...
<h3>        update des evenements</h3>
              <div class="card-footer">
                ...
                <div >
                 ...
                 <select name="genre" id="" type="text">
                      <option value="INTERNATIONAL">INTERNATIONAL</option>
                      <option value="NATIONALL">NATIONALL</option>
              ...
              <!-- afficher  -->
                ...
                <a href="afficher.php">
                <button name="afficher" type="submit" class="btn btn-primary"    >Afficher </button>
