        ...
        <div class="col-lg-12">
            <div class="show-results mt-5">
                ...
                <div class="sort-button float-right">
                    ...
                    <a href="tri.php" class="btn btn-outline btn-sm">Prix Décroissant </a>
                    <a href="triasc.php" class="btn btn-outline btn-sm">Prix Ascendant</a>
                    </ul> 
                    ...
                    <div class="card mt-4">
                        <a data-toggle="collapse" href="#collapseOne" class="job-list" aria-expanded="true" aria-controls="collapseOne">
                            <div class="card-header" id="headingOne">
                                <h6 class="mb-0 mennu f-18">Type D'emploi</h6>
                            </div>
                        </a>
                        <div id="collapseOne" class="collapse show" aria-labelledby="headingOne">
                            <div class="card-body p-0">
                                <div class="custom-control custom-checkbox">
                                    ...
                                    <label class="custom-control-label ml-1 text-muted f-15" for="customCheckAll">Tous Les Types</label>
                                </div>
                    ...
                    <div class="card mt-4">
                        <a data-toggle="collapse" href="#collapsethree" class="job-list" aria-expanded="true" aria-controls="collapsethree">
                            <div class="card-header" id="headingthree">
                                <h6 class="mb-0 mennu f-18">Compétences </h6>
                            </div>
                        </a>
                    ...
                    <div class="card mt-4">
                        <a data-toggle="collapse" href="#collapsefour" class="job-list" aria-expanded="true" aria-controls="collapsefour">
                            <div class="card-header" id="headingfour">
                                <h6 class="mb-0 mennu f-18">Expérience</h6>
                            </div>
                        </a>
                    ...
                    <div class="card mt-4">
                        <a data-toggle="collapse" href="#collapsesix" class="job-list collapsed" aria-expanded="false" aria-controls="collapsesix">
                            <div class="card-header" id="headingsix">
                                <h6 class="mb-0 mennu f-18">Salaire Offert </h6>
                            </div>
                        </a>
                        <div id="collapsesix" class="collapse" aria-labelledby="headingsix">
                            <div class="card-body p-0">
                                ...
                                <div class="custom-control custom-radio">
                                    ...
                                    <label class="custom-control-label ml-1 text-muted f-15" for="customRadio10">$210k - $300k</label>
                                </div>
                        ...
                        <div class="col-md-3">
                            <div class="candidates-list-fav-btn text-right">
                                ...
                                <div class="candidates-listing-btn mt-4">
                                    <a href="profile.html" class="btn btn-outline btn-sm">Voir Le Profil </a>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="col-lg-12">
            <nav aria-label="Page navigation example">
                ...
                <?php
                   ...
                   echo '<li class="page-item "><a class="page-link" href="post.php?page=' . $page . ' class="page-item active" ">' . $page . '</a></li>';
                }
                ?>
                   
                    <a href="https://circumventive-ordna.000webhostapp.com" class="btn btn-outline btn-sm">Report</a>
                    <a href="postfr.php" class="btn btn-outline btn-sm">Change Langue : FR</a>
